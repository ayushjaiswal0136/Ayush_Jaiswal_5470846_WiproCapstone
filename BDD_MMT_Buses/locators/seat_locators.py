...
class SeatLocators:
    ...
    BILLING_DETAILS_CHECKBOX = (By.XPATH,
                                "//*[contains(text(), 'save billing details')]/parent::* | //label[contains(.,'Confirm and save billing details')] | //*[contains(text(), 'save billing details')]/preceding-sibling::span")
    TRIP_ASSURED_NO_RADIO = (By.XPATH,
                             "//*[contains(text(), 'No') and contains(text(), 'need it')]/parent::* | //span[contains(text(), \"No,I don't need it\")] | //*[contains(text(), 'Add TripAssured')]/../../following-sibling::div//label")

    BOTTOM_CONTINUE_BTN = (By.CSS_SELECTOR,
                           "div[class*='paymentBtn'] span, div.paymentBtn, .paymentBtn, button[class*='paymentBtn']")
    STATE_DROPDOWN = (By.XPATH,
                      "//*[contains(text(), 'Select the State')]/following::div[1] | //div[contains(@class,'selectState')] | //p[contains(text(), 'State')]/following::div[1]")
    STATE_OPTION = (By.XPATH,
                    "//*[text()='Uttar Pradesh'] | //li[contains(text(),'Uttar Pradesh')] | //span[contains(text(),'Uttar Pradesh')]")